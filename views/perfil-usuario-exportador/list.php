                ...
                'columns' => [
                    ...
                    [
                        ...
                        'value' => function($model){
                            ...
                            $ver='<a href="index.php?r=perfil-usuario-exportador/view&id='.$model->a02_id.'" title="Ver" aria-label="Ver" data-pjax="0"><span class="glyphicon glyphicon-eye-open"></span></a>';
                            ...
                            if($model->a02_ismed==1){
                                ...
                                if($medico) {
                                    ...
                                    $editar='<a href="index.php?r=-exportador/update&id='.$model->a02_id.'" title="Editar" aria-label="Editar" data-pjax="0"><span class="glyphicon glyphicon-pencil"></span></a>';
                                ...
                                $editar='<a href="index.php?r=perfil-usuario-exportador/update&id='.$model->a02_id.'" title="Editar" aria-label="Editar" data-pjax="0"><span class="glyphicon glyphicon-pencil"></span></a>';
                                //$asignacion='<a href="index.php?r=/admin/assignment/view&id='.$model->a02_id.'" title="Asignación" aria-label="Asignación" data-pjax="0"><span class="glyphicon glyphicon-pushpin"></span></a>';
