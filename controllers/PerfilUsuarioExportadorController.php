...
class PerfilUsuarioExportadorController extends Controller
{
    /**
     * @inheritdoc
     */
    ...
    {
        $unidades = Upp::getUppsPorProductors(PerfilUsuario::findOne($id)->c01_id);
    ...
    public function actionList(){
        $searchModel = new PerfilusuarioSearch();
        $dataProvider = $searchModel->search(Yii::$app->request->queryParams);
        //$dataProvider = PerfilUsuario::getAllExportadores();
    ...
    public function actionBuscarproductor($productor){
        $prod = Ganaderos::findOne($productor);
        if($prod){
            $arr[0] = $prod->c01_nombre;
            $arr[1] = $prod->c01_apaterno;
            $arr[2] = $prod->c01_amaterno;
            $arr[3] = $prod->c01_correo;
            $arr[4] = $prod->c01_telefono;
            $arr[5] = $prod->c01_calle.", ".$prod->c01_colonia." C.P.".$prod->c01_cp;
        }else{
            $arr[0]="";
            $arr[1]="";
            $arr[2]="";
